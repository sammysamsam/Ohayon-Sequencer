...
public class ThermodynamicsCalculator {
	...
	HashMap<String,ThermodynamicParameter> hmap = new HashMap<String,ThermodynamicParameter>();
	...
	** * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	private double saltcorrection(double Tm,Strand a){
		if(this.Salt.equalsIgnoreCase("Mg")){
			...
			Tm = Tm + (1/(2*(a.length-1)))*(-.000482+(.000525*java.lang.Math.log(this.SaltCt)) +(.0000831*java.lang.Math.log(this.SaltCt)*java.lang.Math.log(this.SaltCt)));
			return 1/Tm;
		}
		else{
			return Tm;
